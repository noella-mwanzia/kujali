...
import { ExpenseAllocs } from "@app/model/finance/operations/expenses";

@Injectable()
export class ExpensesAllocsStore extends DataStore<ExpenseAllocs>
{
  protected _activeRepo!: Repository<ExpenseAllocs>;
  ...
  constructor(org$$: ActiveOrgStore,
    ...
    const data$ = org$$.get()
            .pipe(tap((o)  => 
                      this._activeRepo = !!o ? dataService.getRepo<ExpenseAllocs>(`orgs/${o.id}/expenses-allocs`) 
                                                    : null as any),
