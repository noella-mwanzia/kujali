...
export class PermissionsFormsService {
  ...
  _initPermissionsFormGroup(permissionsFormGroup: FormGroup, permissions: KujaliPermissions) {
  ...
  patchRole(permissions: KujaliPermissions, domainKey: string, domainGroup: string, permissionsGroup: FormGroup) {
    let domain = permissions[domainKey];
