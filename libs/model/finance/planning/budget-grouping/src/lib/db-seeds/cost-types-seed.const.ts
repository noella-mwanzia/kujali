...
const INC_SLS            = { id: 'i1', name: 'INCOME-TYPES.SALES.MAIN', order: 1, type: BudgetRowType.CostLine } as LoadedTransactionType;
...
const INC_INV         = { id: 'i2', name: 'INCOME-TYPES.INVS.MAIN', order: 1, type: BudgetRowType.CostLine } as LoadedTransactionType;
...
// COSTS 2. EXPENSES
const COST_EXPENSES = { id: 'c2', name: '', order: 1, type: BudgetRowType.CostLine } as TransactionTypeCategory;
...
// COSTS 3. INVESTMENTS
const COST_INVESTMENTS = { id: 'c3', name: '', order: 1, type: BudgetRowType.CostLine } as TransactionTypeCategory;
